...
import com.shiki.utils.io.stream.ByteArrayOutputStream;
import com.shiki.utils.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static void writeLines(Collection<?> lines, String lineEnding, OutputStream output, Charset encoding) throws IOException {
        if (lines != null) {
            ...
            for (Iterator var5 = lines.iterator(); var5.hasNext(); output.write(StringCodingUtils.getBytes(lineEnding, cs))) {
