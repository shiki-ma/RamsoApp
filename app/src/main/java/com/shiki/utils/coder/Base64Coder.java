...
public class Base64Coder {
    ...
    public static byte[] decode(byte[] input, int offset, int len, int flags) {
        Base64Coder.Decoder decoder = new Base64Coder.Decoder(flags, new byte[len * 3 / 4]);
    ...
    public static byte[] encode(byte[] input, int offset, int len, int flags) {
        Base64Coder.Encoder encoder = new Base64Coder.Encoder(flags, (byte[]) null);
    ...
    static class Encoder extends Base64Coder.Coder {
    ...
    static class Decoder extends Base64Coder.Coder {
