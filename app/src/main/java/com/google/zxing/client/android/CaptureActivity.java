...
public abstract class CaptureActivity extends Activity implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        operateView = (ImageView) findViewById(R.id.button_openorcloseClick);

        operateView.setOnClickListener(new OnClickListener() {
    ...
    protected abstract void processCode(String codeText);
