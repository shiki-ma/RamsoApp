 ...
 */
public class BoxFragment extends BaseFrament {
    ...
    protected void initData() {
        ...
        info.setImgResource(R.drawable.ic_weather);
        menuInfos.add(info);
        info = new MenuInfo();
        info.setImgResource(R.drawable.ic_map);
        menuInfos.add(info);
        info = new MenuInfo();
        info.setImgResource(R.drawable.ic_notice);
        menuInfos.add(info);
        info = new MenuInfo();
        info.setImgResource(R.drawable.ic_setting);
        menuInfos.add(info);
        info = new MenuInfo();
