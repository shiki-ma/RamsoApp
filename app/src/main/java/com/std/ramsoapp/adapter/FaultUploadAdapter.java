 ...
 */
public class FaultUploadAdapter extends FGORecyclerViewAdapter<FaultUploadAdapter.ModeViewHolder> {
    private List<PhotoInfo> photoInfoList;
    private Activity mActivity;


    public FaultUploadAdapter(List<PhotoInfo> photoInfoList, Activity activity) {
