...
import com.std.ramsoapp.fragments.FaultListFragment;
...
public class FaultListActivity extends BaseActivity {
    private static final String[] TITLE = new String[]{"待处理", "待审核", "已审核"};
    ...
    protected void preData() {
        ...
        content_list.add(FaultListFragment.newInstance(Constant.FAULT_BEFORE_DEAL));
        content_list.add(FaultListFragment.newInstance(Constant.FAULT_BEFORE_REVIEW));
        content_list.add(FaultListFragment.newInstance(Constant.FAULT_AFTER_REVIEW));
    }
    ...
    private void refresh() {
        ...
        for (int i = 0; i < pageCount; i++) {
            FaultListFragment faultList = (FaultListFragment) mFaultPager.getAdapter().instantiateItem(mFaultPager, i);
